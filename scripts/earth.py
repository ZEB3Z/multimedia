"""
Earth — texture + atmosphere. Requires sun_bg (or any script that calls ensure_base_scene).
Texture: C:\\BlenderTextures\\earth_color.jpg
"""
...
def main():
    ...
    sc.build_planet(BODY, d, with_atmosphere=True, roughness=0.60, specular=0.30)
